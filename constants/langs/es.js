...
export const es = {
  ...
  environmentalImpact: {
    Intro: {
      ...
      sectionBody:
        "En la siguiente sección encontrarás datos sobre el consumo de la inteligencia artificial, y consejos para tener en cuenta en el uso de herramientas de inteligencia artificial.",
    },
    fact: "dato",
    advice: "consejo",
    source: "Fuente: ",
    firstSection: {
      ...
      highlight: {
        title: "Destacado",
        body: "Lorem ipsum dolor sr sit amet risus malesuada aliquet. In efficitur, purus ac vehicula gravida, sapien justo luctus metus, id fermentum augue est in nunc. Aliquam erat volutpat.",
